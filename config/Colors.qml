// config/Colors.qml
//
// Jedno miejsce, jedno źródło prawdy dla kolorów. Reszta configu odwołuje
// się po nazwie (Colors.red, Colors.sky, itd.), nigdy po surowym hexie.
//
// "pragma Singleton" na samej górze pliku to specjalna dyrektywa: mówi
// silnikowi QML "istnieje tylko JEDNA instancja tego typu w całym
// configu, i każdy plik, który się do niej odwoła, dostaje TĘ SAMĄ
// instancję" — jak zmienna globalna, tylko bezpieczna (bo readonly).
//
// Quickshell wykrywa ten plik jako singleton dzięki dwóm rzeczom:
// 1. nazwa pliku zaczyna się wielką literą (Colors.qml, nie colors.qml)
// 2. `pragma Singleton` jest pierwszą linią pliku, przed importami
